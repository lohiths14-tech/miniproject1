...
Handles real-time collaboration endpoints for WebSocket-based pair programming
"""

from flask import Blueprint, request, jsonify, session
# from flask_socketio import SocketIO, emit, join_room, leave_room, rooms
from services.collaboration_service import collaboration_service, UserRole, SessionStatus
...
def create_session():
    ...
    try:
        ...
        user_id = data.get('user_id') or session.get('user_id', 'demo_user')
...
def create_sample_session():
    ...
    try:
        ...
        collaboration_service.apply_code_change('demo_host', {
            'operation': 'insert',
            'position': 0,
        ...
        if session_id and user_id:
            ...
            if success:
                ...
                emit('help_request_sent', {
                    'status': 'success',
                    'message': 'Help request sent to available lecturers'
                })
            else:
                emit('help_request_sent', {
                    'status': 'error',
