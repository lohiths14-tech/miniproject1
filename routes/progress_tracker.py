...
def delete_student_data(student_id):
    ...
    try:
        ...
        if success:
            return jsonify({
                'success': True,
                'message': f'All submissions for {student_id} have been deleted'
            })
        else:
            return jsonify({
                'success': False,
                'error': 'Student not found or no submissions to delete'
            }), 404
    except Exception as e:
        return jsonify({
            'success': False,
...
def clear_all_submissions():
    ...
    try:
        ...
        if success:
            return jsonify({
                'success': True,
                'message': 'All submission data has been cleared'
            })
        else:
            return jsonify({
                'success': False,
