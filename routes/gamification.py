...
def get_user_stats():
    ...
    try:
        # In a real implementation, get user_id from session/JWT
...
def award_points():
    """Award points for a specific action (internal API)"""
    try:
    ...
    try:
        ...
        return jsonify({
            ...
            'data': {
                ...
                'total_points_earned': submission_result['points_earned'] + (speed_result['points_earned'] if speed_result else 0)
            }
        })
