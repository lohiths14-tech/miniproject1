...
def get_all_templates():
    ...
    try:
        ...
        templates = template_service.get_all_templates(
            category=category, difficulty=difficulty, language=language, search_term=search
        )

        return jsonify({"success": True, "data": templates, "total": len(templates)})
...
def create_template():
    ...
    try:
        ...
        return (
            jsonify(
                {"success": True, "data": new_template, "message": "Template created successfully"}
            ),
            201,
        )
    except (ValueError, KeyError, AttributeError) as e:
...
def update_template(template_id):
    ...
    try:
        ...
        return jsonify(
            {"success": True, "data": updated_template, "message": "Template updated successfully"}
        )
    except (ValueError, KeyError, AttributeError) as e:
        return jsonify({"success": False, "error": str(e)}), 500
...
def rate_template(template_id):
    ...
    try:
        ...
        return jsonify({"success": True, "message": "Template rated successfully"})
    except (ValueError, KeyError, AttributeError) as e:
        return jsonify({"success": False, "error": str(e)}), 500
...
def get_popular_templates():
    ...
    try:
        ...
        return jsonify({"success": True, "data": popular_templates})
    except (ValueError, KeyError, AttributeError) as e:
        return jsonify({"success": False, "error": str(e)}), 500
...
def get_recent_templates():
    ...
    try:
        ...
        return jsonify({"success": True, "data": recent_templates})
    except (ValueError, KeyError, AttributeError) as e:
        return jsonify({"success": False, "error": str(e)}), 500
