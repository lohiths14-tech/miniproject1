...
"""
import docker
from docker.types import Resources, Mount
import tempfile
import os
import json
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                container_config = {
                    ...
                    'command': self._get_run_command(language, '/code/' + os.path.basename(code_file)),
                    'stdin_open': True,
                    'mem_limit': '256m',
                    ...
                    'detach': True,
                    'mounts': [
                        Mount(target='/code', source=tmpdir, type='bind', read_only=True)
                    ],
