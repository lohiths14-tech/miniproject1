...
class AICodeSuggestionsService:
    ...
    def get_real_time_suggestions(self, code: str, cursor_position: int, 
                                language: str = 'python') -> List[CodeSuggestion]:
        ...
        suggestions.extend(self._get_completion_suggestions(current_line, lines, current_line_index, language))
    ...
    def _get_completion_suggestions(self, current_line: str, lines: List[str], 
                                  line_index: int, language: str) -> List[CodeSuggestion]:
                    ...
                    if isinstance(node, ast.FunctionDef):
                        ...
                        if function_lines > self.refactoring_rules['long_function']['threshold']:
                            suggestions.append(CodeSuggestion(
                                ...
                                suggested_fix=self.refactoring_rules['long_function']['suggestion'],
    ...
    async def get_ai_powered_suggestions(self, code: str, context: str, 
                                       language: str = 'python') -> List[CodeSuggestion]:
        ...
        try:
            ...
            response = await openai.ChatCompletion.acreate(
                model="gpt-3.5-turbo",
                messages=[
                    {"role": "system", "content": "You are an expert programming assistant focused on code quality and best practices."},
